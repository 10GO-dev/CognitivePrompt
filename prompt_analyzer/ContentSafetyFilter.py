...
class TextCategorySensitivity(str, enum.Enum):
    DISABLE = "disable"
...
class AzureContentSafety(ToolProvider):
    ...
    def analyze_text(
        ...
        decision_result["desicions"] = convert_decision_to_json(content_safety.make_decision(detection_result, reject_thresholds))
        return 
